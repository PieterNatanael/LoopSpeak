...
//                            .foregroundColor(.white)
            ...
            Button(action: {
                ...
                Text(isReading ? "Stop" : "Start")
                    ...
                    .padding()
                    .foregroundColor(.white)
                    .background(isReading ? Color.red : Color.purple)
                    .cornerRadius(10)
            }
...
//                    }
                    ...
                    VStack {
                        ...
                        AppCardView(imageName: "timetell", appName: "TimeTell", appDescription: "Tell the time every 30 seconds, no more guessing and checking your watch, for time-sensitive tasks.", appURL: "https://apps.apple.com/id/app/loopspeak/id6473384030")
                        Divider().background(Color.gray)
...
/*
//udah bagus, mau ada revisi sedikit
